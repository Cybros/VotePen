...
Route::group(['middleware' => ['auth:api']], function () {
    ...
    // feedback
    Route::get('/feedbacks/{feedback}', 'FeedbacksController@get')->middleware('votepen-administrator'); // checked
    Route::get('/feedbacks', 'FeedbacksController@index')->middleware('votepen-administrator'); // checked
    Route::post('/feedbacks', 'FeedbacksController@store')->middleware('shaddow-ban'); // checked
    Route::delete('/feedbacks/{feedback}', 'FeedbacksController@destroy')->middleware('votepen-administrator'); // checked
    ...
    Route::delete('/admin/users', 'UserController@destroyAsVotePenAdministrator')->middleware('votepen-administrator'); // checked
    ...
    Route::get('/users/submissions/upvoted', 'UserController@upVotedSubmissions'); // checked 
    Route::get('/users/submissions/downvoted', 'UserController@downVotedSubmissions'); // checked 
    Route::post('/email/verify/resend', 'Auth\VerificationController@resendVerifyEmailAddress'); // checked 
    Route::post('/clientside-settings', 'ClientsideSettingsController@store'); // checked 
    Route::get('/clientside-settings', 'ClientsideSettingsController@get'); // checked 
    ...
    Route::post('/channels/{channel}', 'ChannelController@destroy')->middleware('votepen-administrator');
    ...
    // (admin)
    Route::post('/admin/users/bans', 'BanController@storeAsVotePenAdministrator')->middleware('votepen-administrator');
    Route::get('/admin/users/bans', 'BanController@indexAsVotePenAdministrator')->middleware('votepen-administrator');
    Route::delete('/admin/users/bans', 'BanController@destroyAsVotePenAdministrator')->middleware('votepen-administrator');
